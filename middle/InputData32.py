...
#훈련 이미지의 모든 경로 불러오기
data_list01 = glob('C:\\python\\DeepLearning\\traindata32\\pose01\\*.jpg')
length01=len(data_list01)

data_list02 = glob('C:\\python\\DeepLearning\\traindata32\\poes02\\*.jpg')
length02=len(data_list02)

data_list03 = glob('C:\\python\\DeepLearning\\traindata32\\pose03\\*.jpg')
length03=len(data_list03)

data_list04 = glob('C:\\python\\DeepLearning\\traindata32\\pose04\\*.jpg')
length04=len(data_list04)

data_list05 = glob('C:\\python\\DeepLearning\\traindata32\\pose05\\*.jpg')
length05=len(data_list05)

data_list06 = glob('C:\\python\\DeepLearning\\traindata32\\pose06\\*.jpg')
length06=len(data_list06)

data_list07 = glob('C:\\python\\DeepLearning\\traindata32\\pose07\\*.jpg')
length07=len(data_list07)

data_list08 = glob('C:\\python\\DeepLearning\\traindata32\\pose08\\*.jpg')
length08=len(data_list08)

data_list09 = glob('C:\\python\\DeepLearning\\traindata32\\pose09\\*.jpg')
length09=len(data_list09)

data_list10 = glob('C:\\python\\DeepLearning\\traindata32\\pose10\\*.jpg')
...
train_images = np.zeros((Data_length, 32, 32, 3))
...
for i in range(0,10):
    if(i==0):
        ...
        for j in range(length06):
            train_images[j+length1+length2+length03+length04+length05:,:,:]=(np.array(pilimg.open(data_list06[j])))/255.0
            print(i,j)
    elif(i==6):
        for j in range(length07):
            train_images[j+length1+length2+length03+length04+length05+length06:,:,:]=(np.array(pilimg.open(data_list07[j])))/255.0
            print(i,j)
    elif(i==7):
        for j in range(length08):
            train_images[j+length1+length2+length03+length04+length05+length06+length07:,:,:]=(np.array(pilimg.open(data_list08[j])))/255.0
            print(i,j)
    elif(i==8):
        for j in range(length09):
            train_images[j+length1+length2+length03+length04+length05+length06+length07+length08:,:,:]=(np.array(pilimg.open(data_list09[j])))/255.0
            print(i,j)
    elif(i==9):
        for j in range(length10):
            train_images[j+length1+length2+length03+length04+length05+length06+length07+length08+length09:,:,:]=(np.array(pilimg.open(data_list10[j])))/255.0
            print(i,j)        
    else:
        break
...
data_list01 = glob('C:\\python\\DeepLearning\\testdata32\\pose01\\*.jpg')
length01=len(data_list01)

data_list02 = glob('C:\\python\\DeepLearning\\testdata32\\poes02\\*.jpg')
length02=len(data_list02)

data_list03 = glob('C:\\python\\DeepLearning\\testdata32\\pose03\\*.jpg')
length03=len(data_list03)

data_list04 = glob('C:\\python\\DeepLearning\\testdata32\\pose04\\*.jpg')
length04=len(data_list04)

data_list05 = glob('C:\\python\\DeepLearning\\testdata32\\pose05\\*.jpg')
length05=len(data_list05)

data_list06 = glob('C:\\python\\DeepLearning\\testdata32\\pose06\\*.jpg')
length06=len(data_list06)

data_list07 = glob('C:\\python\\DeepLearning\\testdata32\\pose07\\*.jpg')
length07=len(data_list07)

data_list08 = glob('C:\\python\\DeepLearning\\testdata32\\pose08\\*.jpg')
length08=len(data_list08)

data_list09 = glob('C:\\python\\DeepLearning\\testdata32\\pose09\\*.jpg')
length09=len(data_list09)

data_list10 = glob('C:\\python\\DeepLearning\\testdata32\\pose10\\*.jpg')

length10=len(data_list10)

Data_length=length01+length02+length03+length04+length05+length06+length07+length08+length09+length10
test_images = np.zeros((Data_length, 32, 32, 3))
...
np.save('C:\\python\\DeepLearning\\numpydata\\train_images32.npy', train_images)
np.save('C:\\python\\DeepLearning\\numpydata\\train_labels32.npy', train_labels)
np.save('C:\\python\\DeepLearning\\numpydata\\test_images32.npy', test_images)
np.save('C:\\python\\DeepLearning\\numpydata\\test_labels32.npy', test_labels)